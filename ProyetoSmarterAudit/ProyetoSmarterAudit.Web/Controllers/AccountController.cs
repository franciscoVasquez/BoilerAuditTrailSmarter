...
using ProyetoSmarterAudit.Web.Controllers.Results;
using ProyetoSmarterAudit.Web.Models.Account;
...
{
    public class AccountController : ProyetoSmarterAuditControllerBase
    {
